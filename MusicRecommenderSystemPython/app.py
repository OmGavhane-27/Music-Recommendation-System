...
while cap.isOpened():
    ...
    try:
        for (x,y, w, h) in faces:
            ...
            lstem.append(emotion_prediction)
    ...
    if cv2.waitKey(1) & 0xFF == ord('q'):
        break
emotion1 = ','.join(map(str, lstem))
insertEmotions(userid,emotion1)
 
print("<html>")
print("<head>")
print("<meta http-equiv='refresh' content='0;url=http://localhost:8080/FromPython?sts=success&userid="+userid+"'/>")
print("</head>")
print("</html>")
