...
%>
<h2><%
if(request.getAttribute("activity").toString().trim().equals("SongReg"))
{
	%>
	Song Registered Successfully...
	<%
}
else if(request.getAttribute("activity").toString().trim().equals("emotion"))
{
	%>
	Emotion Tracked Successfully...
...
else if(request.getAttribute("activity").toString().trim().equals("deleteDoc"))
{
	%>
